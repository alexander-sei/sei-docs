...
```solidity title="script/DeployCounter.s.sol"
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.22;
...
```solidity title="src/SeiToken.sol"
...
```solidity title="script/DeploySeiToken.s.sol"
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.22;
...
```solidity title="script/DeploySeiNFT.s.sol"
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.22;
...
```solidity title="test/SeiToken.t.sol"
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.22;
...
```solidity title="test/SeiNFT.t.sol"
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.22;
