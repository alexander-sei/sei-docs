...
```plaintext PRIVATE_KEY=your_private_key_here
...
```typescript // Import ethers for contract interactions
...
```typescript // Create a pointer for native SEI tokens
...
```solidity contract NativePointerManager {
    IPointerPrecompile constant POINTER = IPointerPrecompile(0x000000000000000000000000000000000000100B);
...
```typescript // Create a pointer for a CW20 token
...
```solidity contract CW20PointerManager {
    IPointerPrecompile constant POINTER = IPointerPrecompile(0x000000000000000000000000000000000000100B);
...
```typescript // Create a pointer for a CW721 NFT contract
...
```solidity contract CW721PointerManager {
    IPointerPrecompile constant POINTER = IPointerPrecompile(0x000000000000000000000000000000000000100B);
...
```typescript // After creating a native pointer for a native token
...
```typescript // Interact with CW20 pointer as erc20
...
```typescript const ERC721_ABI = ['function balanceOf(address) view returns (uint256)', 'function ownerOf(uint256) view returns (address)', 'function transferFrom(address, address, uint256)', 'function approve(address, uint256)'];
...
```typescript // Handle common pointer creation errors
...
```typescript // Proper gas estimation for different pointer types
