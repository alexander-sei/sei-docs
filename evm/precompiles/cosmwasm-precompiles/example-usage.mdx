...
this example, we're going to be using the [wasmd precompile](/evm/precompiles/cosmwasm-precompiles/cosmwasm):
    ...
    ```typescript     // Import Wasm precompile address and ABI
...
```typescript import { ethers, toUtf8Bytes, toUtf8String } from 'ethers';
...
```typescript // Replace with your contract
...
```typescript // Execute a message to donate to the contract.
