...
<Columns cols={2}>
  <Card title="Traditional Blockchain">
...
<Columns cols={2}>
  <Card title="Data Dissemination Layer (Lanes)">
  ...
  <Card title="Consensus Layer (Cut Formation)">
...
<Columns cols={3}>
  <Card title="Flat KV Store">
    LSM-tree based
  </Card>
  <Card title="Cryptographic Accumulators">
    Compact proofs
  </Card>
...
<Columns cols={2}>
  <Card title="Liveness Failures">
    Penalties for downtime
  </Card>
  <Card title="Safety Violations">
...
<Card title="Current Implementation — Live on Mainnet" icon="check">
  <Columns cols={3}>
    <Card title="Twin Turbo Consensus">
      ~400ms blocks
    </Card>
    <Card title="Parallel Execution">
      Multi-core processing
    </Card>
    <Card title="SeiDB Storage">
      Optimized state access
    </Card>
  </Columns>
</Card>

<Card title="Upcoming Features — In Development" icon="clock">
  <Columns cols={3}>
    <Card title="Autobahn Consensus">
      Multi-proposer protocol
    </Card>
    <Card title="5 Gigagas Throughput">
      Performance target
    </Card>
    <Card title="Advanced Optimizations">
      Enhanced execution
    </Card>
  </Columns>
</Card>
