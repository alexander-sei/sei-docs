...
<Columns cols={3}>
  <Card title="EVM Cache System" />
  <Card title="Query Processor" />
  <Card title="Storage Engine" />
</Columns>

<Columns cols={3}>
  <Card title="Merkle Trie Optimizer" />
  <Card title="Storage Indexer" />
  <Card title="LSM-Tree Manager" />
</Columns>

<Columns cols={3}>
  <Card title="Concurrency Control" />
  <Card title="Version Manager" />
  <Card title="I/O Scheduler" />
</Columns>

<Card title="Ethereum Compatibility Layer" />
