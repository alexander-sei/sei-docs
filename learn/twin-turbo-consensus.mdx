...
<Columns cols={2}>
  <Card title="Pre-Consensus (TX Preparation)">
    - Transaction Collection & Analysis
    - State Prefetching (SeiDB)
  </Card>
  <Card title="Optimized BFT Consensus (Voting & Concurrent Execution)">
...
_(Consensus Reached)_ → **Finalize State & Commit to SeiDB**
