...
<iframe
  src="https://widgets.sei.io/add-sei-button?network=pacific-1&label=Add+Sei+Mainnet+to+your+wallet"
...
<iframe
  src="https://widgets.sei.io/add-sei-button?network=atlantic-2&label=Add+Sei+Testnet+to+your+wallet"
  style={{ width: "100%", minHeight: "72px", border: "0" }}
  loading="lazy"
